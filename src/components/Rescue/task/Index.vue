...
@import "../../../assets/css/all.scss"; $size: 44px;
.personal { position: fixed; background-color: white; border-radius: 100%; bottom: 20px; box-shadow: 0 4px 10px rgba(0, 0, 0, .1); height: $size; left: 20px; line-height: $size; text-align: center; width: $size;
    i { font-size: 24px; font-weight: bold;}}

.task { min-height: 100%;
    .nav { background-color: white; display: flex; justify-content: space-around;
        li { color: $gray; flex: 1; line-height: 43px; text-align: center;
            span { border-bottom: 2px solid transparent; display: inline-block; line-height: 40px;}}
        li.checked span { border-color: $red; color: $red;}}
    .Empty { text-align: center;
        i { color: #BFBFBF; display: block; font-size: 70px; margin: 80px 0 28px;}
        p { color: #848689; font-size: 17px;}}}

</style>
<style lang="scss">
@import "../../../assets/css/all.scss";

.ordersComm { li.order { background-color: white; margin-top: 10px;
        a { display: block;}}
    .track { border-top: 1px solid #F0F0F0; display: flex; padding: 15px;
        .iconfont { color: #666666; font-size: 20px; margin-right: 10px;}
        .r { flex: 1;
            h2 { font-size: 12px; font-weight: normal;}
            span { color: #8B8B8B; display: block; font-size: 12px; margin-top: 10px;}}}
     > a { display: block;}
    .title { display: flex; justify-content: space-between; line-height: 40px; padding: 0 15px;
        span { color: $red;}}
    .info { align-items: center; background-color: #F8F8F8; display: flex; padding: 10px 15px;
        .icon { display: block; height: 70px; margin-right: 10px; width: 70px;}
    ...
    .btn { display: flex; font-size: 14px; justify-content: flex-end; padding: 5px 0;
        input { background-color: white; border: 1px solid #333333; border-radius: 3px; height: 28px; margin-right: 10px; width: 75px;}

        .file { position: relative; border: 1px solid #333333; border-radius: 3px; height: 26px; line-height: 28px; margin-right: 10px; overflow: hidden; text-align: center; width: 73px;
            span { font-size: 13px; line-height: 28px;}
            input { position: absolute; left: 0; opacity: 0; top: 0;}}}}
