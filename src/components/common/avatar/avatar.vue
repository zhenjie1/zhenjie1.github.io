...
.avatar { @include screen; background-color: transparent;
    ...
    .item { position: relative; background-color: white; font-size: 16px; line-height: 60px; text-align: center;}
    .item + .item { border-top: 1px solid #F0F0F0;}
    .cell { margin-top: 10px;}
    .content { position: absolute; background-color: #F5F5F5; bottom: 0; left: 0; width: 100%;}}
