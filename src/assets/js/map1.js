		...
		if (data.status === 0) {
			new Promise((rej, res) => {
				...
				if (enterStr == 'home') {
					...
					// console.log(sessionStorage.lngLat)
...
export const loadScript = function (enter) {
	console.log(33)
	enterStr = enter
	var mapUrl = "http://api.map.baidu.com/api?v=2.0&ak=FdnveqDZGzZHbnx08vngQUBH4BNkzi3C&callback=initialize"
